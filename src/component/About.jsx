  ...
  return (
    <div className="min-h-screen pt-24 pb-8 px-8 bg-gradient-to-b from-gray-800 via-gray-900 to-black text-gray-300">
      ...
      <section className="mb-8 animate-fadeIn">
        <h1 className="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-teal-400 via-blue-500 to-purple-600 drop-shadow-lg mb-4 text-center">
          About Codenest
        </h1>
      ...
      <section className="my-12 px-8 py-6 bg-gray-800 rounded-lg shadow-lg animate-fadeIn">
        <h2 className="text-3xl font-semibold text-gray-300 mb-6 text-center">What Users Are Saying</h2>
